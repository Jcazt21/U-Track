...
class Administrador(models.Model):
    ...
    Imagen = models.ImageField(upload_to='Imagenes/Imagenes_Administrador', null=True, blank=True)
...
class Materia(models.Model):
    ...
    Codigo_Materia=models.CharField(max_length=5)
...
class Profesor(models.Model): 
    ...
    ID_Usuario=models.ForeignKey(get_user_model(),models.DO_NOTHING)
    Imagen = models.ImageField(upload_to='Imagenes/Imagenes_Profesor', null=True, blank=True)
    Activo = models.BooleanField(default=True)
...
class Estudiante(models.Model): 
    ...
    Imagen = models.ImageField(upload_to='Imagenes/Imagenes_Estudiantes', null=True, blank=True)
    Activo = models.BooleanField(default=True)
